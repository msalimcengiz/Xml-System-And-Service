<div class="body-title">Xml Marka Eşleme</div>
<div class="body-body">
	<div class="row">
		<div class="col-lg-12">
			<button type="button" class="btn btn-primary" style="margin-bottom:25px;" onclick="saveBrands()">Kaydet</button>
		</div>
		<div class="col-lg-12">
